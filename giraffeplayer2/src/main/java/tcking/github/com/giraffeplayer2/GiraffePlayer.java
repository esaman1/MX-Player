...
public class GiraffePlayer implements MediaController.MediaPlayerControl {
    ...
    private final boolean canPause = true;
    private final Map<String, String> headers = new HashMap<>();
    private final Context context;
    private final Handler handler;
    private final Handler uiHandler = new Handler(Looper.getMainLooper());
    private final ProxyPlayerListener proxyListener;
    private final VideoInfo videoInfo;
    private final WeakReference<? extends ViewGroup> boxContainerRef;
    ...
    public GiraffePlayer setDisplayModel(int targetDisplayModel) {
        ...
        if (targetDisplayModel == DISPLAY_FULL_WINDOW) {
            ...
            UIHelper uiHelper = UIHelper.with(activity);
            if (videoInfo.isPortraitWhenFullScreen()) {
                uiHelper.requestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT);
                ignoreOrientation = ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT;
            }
